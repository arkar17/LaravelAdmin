  ...
  channel.bind('App\\Events\\Notify', function(data) {
     alert(data.message);
        ...
        <div class="create-user-parent-container">
            <h1>Create Team</h1>
            <form action="{{ route('team_create') }}" method="POST" enctype="multipart/form-data" class="create-user-container">
                @csrf
                ...
                <div class="create-user-inputs-row">
                    ...
                    <input type="text" id="name" name="teamname" placeholder="Enter Team Name"/>
                    </div>
                </div>
