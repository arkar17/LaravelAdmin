<div class="side-bar-container fl-5">
    ...
    <div class="side-bar-links-container">
        ...
        <a class="side-bar-link" href="/create_user">
            <iconify-icon icon="ant-design:user-outlined" class="sidebar-icon"></iconify-icon>
            <span>{{__('msg.user')}}</span>
        </a>
        <div class="side-bar-link-dropdown-container">
          ...
          <div class="side-bar-link-drop-down">
            <a class="side-bar-link-drop-down-link" href="{{route('refereerequests')}}">
                <iconify-icon icon="bi:r-circle" class="sidebar-icon"></iconify-icon>
                <span>{{__('msg.referee')}}</span>
            </a>
          </div>
          <div class="side-bar-link-drop-down">
            <a class="side-bar-link-drop-down-link" href="{{route('operationstaffrequests')}}">
                <iconify-icon icon="emojione-monotone:letter-o" class="sidebar-icon"></iconify-icon>
                <span>{{__('msg.operationstaff')}}</span>
            </a>
          </div>
        </div>
        <div class="side-bar-link-dropdown-container">
          ...
          <div class="side-bar-link-drop-down">
            <a class="side-bar-link-drop-down-link" href="{{route('role.index')}}">
                <iconify-icon icon="eos-icons:cluster-role-binding" class="sidebar-icon"></iconify-icon>
                <span>{{__('msg.role')}}</span>
            </a>
            <a class="side-bar-link-drop-down-link" href="{{route('permission.index')}}">
                <iconify-icon icon="icon-park-outline:permissions" class="sidebar-icon"></iconify-icon>
                <span>{{__('msg.permission')}}</span>
            </a>
          </div>
        </div>
        ...
        <div class="side-bar-link-dropdown-container">
          ...
          <div class="side-bar-link-drop-down">
            <a class="side-bar-link-drop-down-link" href="{{route('refereedata')}}">
                <iconify-icon icon="bi:r-circle" class="sidebar-icon"></iconify-icon>
                 <span>{{__('msg.referee')}}{{__('msg.data')}}</span>
            </a>
