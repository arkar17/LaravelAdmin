...
class DashboardController extends Controller
{
    ...
    public function sysdashboard()
    {
        ...
        if($user->hasRole('system_admin')){
            ...
            $refe_twod_salelists = Twodsalelist::select('number', 'sale_amount')->orderBy('sale_amount', 'DESC')->join('twods', 'twods.id', 'twodsalelists.twod_id')->limit(10)->get();

            $refe_lp_salelists = Lonepyinesalelist::select('number', 'sale_amount')->orderBy('sale_amount', 'DESC')->join('lonepyines', 'lonepyines.id', 'lonepyinesalelists.lonepyine_id')->limit(10)->get();
    ...
    //     $lp_salelists = Lonepyinesalelist::select('number', 'sale_amount')->orderBy('sale_amount', 'DESC')->join('lonepyines', 'lonepyines.id', 'lonepyinesalelists.lonepyine_id')->limit(10)->get();
        ...
        //                     ->having('lonepyines.max_amount','<=',DB::raw('SUM(lonepyinesalelists.sale_amount)'))
        //                     ->get();
    //     return view('RefereeManagement.dashboard', compact('totalcommision','totalprofit','agents', 'sum', 'twod_salelists', 'lp_salelists','Declined_twoDList','Declined_lonepyineList'));
    // }
